...
function SearchSec() {
    ...
    const validateVIN = (vin: string) => {
        if (vin.trim().length !== 17 || !/^[A-Za-z0-9]+$/.test(vin)) {
            setErrorMessage("Invalid VIN format. Must be 17 alphanumeric characters.");
            return false;
        }
    ...
    return (
        <section id='get-report' className="relative bg-transparent bg-gradient-to-t from-[#202b2a] to-[#1e2726] bg-opacity-90 bg-blend-color-burn">
            ...
            <div className=" w-full px-4 py-16 bg-gradient-to-r from-primary to-secondary">
                <div className="max-w-2xl mx-auto" data-aos="fade-up">
                    <h2 className="text-2xl md:text-3xl font-bold text-center text-textcolor mb-8">
                        LET'S KNOW ABOUT YOUR VEHICLE
                    </h2>
                    <p className='text-lg md:text-xl text-center text-textcolor/90 mb-8'>
                        Please enter Your 17 digit vehicle identification no. (VIN).
                    </p>
                    <div className="flex flex-col items-center justify-center gap-4">
                        <Input placeholder="Enter your 17-digit VIN"
                           ...
                           onKeyDown={handleKeyPress}
                            className="bg-textcolor/20 text-textcolor placeholder:text-textcolor/70 border-white/20 focus:border-white rounded-full" />
                        <Button className="bg-[#0B1120] text-white hover:bg-[#0B1120]/90 rounded-full w-fit" onClick={handleSearch}>
                           Get Report
                        </Button>
                    </div>
                    {errorMessage && (
                    ...
                    <p className='text-md md:text-lg text-center text-black my-8'>
                        By continuing you agree to our <Link href="/privacypolicy" className='underline'>Terms & Conditions</Link>
                    </p>
                </div>
            </div>
                ...
                >
                    <defs>
                        <linearGradient id="waveGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                            <stop offset="0%" stopColor="hsl(59 96% 54%)" /> {/* 261 88% 53% */}
                            <stop offset="100%" stopColor="hsl(59 94% 65%)" /> {/* 245 100% 73% */}
                        </linearGradient>
                    </defs>
                    <path d="M283.5,9.7c0,0-7.3,4.3-14,4.6c-6.8,0.3-12.6,0-20.9-1.5c-11.3-2-33.1-10.1-44.7-5.7	s-12.1,4.6-18,7.4c-6.6,3.2-20,9.6-36.6,9.3C131.6,23.5,99.5,7.2,86.3,8c-1.4,0.1-6.6,0.8-10.5,2c-3.8,1.2-9.4,3.8-17,4.7	c-3.2,0.4-8.3,1.1-14.2,0.9c-1.5-0.1-6.3-0.4-12-1.6c-5.7-1.2-11-3.1-15.8-3.7C6.5,9.2,0,10.8,0,10.8V0h283.5V9.7z M260.8,11.3	c-0.7-1-2-0.4-4.3-0.4c-2.3,0-6.1-1.2-5.8-1.1c0.3,0.1,3.1,1.5,6,1.9C259.7,12.2,261.4