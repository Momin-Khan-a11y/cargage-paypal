...
function RecordFoundContent() {
    ...
    const Checkout = () => {
        ...
        router.push(`/checkout?vin=${encodeURIComponent(VIN)}`);
    ...
    return (
        <>
            <div className=' w-full ' >
                <div className='bg-gradient-to-r from-primary to-secondary w-full flex flex-col gap-8 items-center justify-center py-40'>
                    <h1 className='text-4xl font-bold text-textcolor max-w-xl text-center' data-aos="fade-down">Congrats! We've found the VHR for the VIN: {VIN}</h1>
                    <Button className='px-10 py-4 rounded-full bg-black text-white hover:bg-black/60' onClick={Checkout} data-aos="fade-up">
                        Purchase
                    </Button>
                    <p className="text-textcolor text-lg font-semibold text-center max-w-md mx-auto">
                        Fast, secure, and comprehensive vehicle reports.
                    </p>
                </div>
